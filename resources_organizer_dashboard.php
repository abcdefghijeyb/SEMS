...
<head>
    ...
    <style>
        html, body {margin:0; padding:0; background:#f8fafc; min-height:100vh; font-family:'Roboto', Arial, sans-serif;}
        body {display: flex; flex-direction: column; min-height: 100vh;}
        .navbar {display: flex; align-items: center; justify-content: space-between; background: #fff; box-shadow: 0 2px 14px #e6eaf3; padding: 0 36px; height: 70px;}
        ...
        .menu a {color: #273659; text-decoration: none; font-weight: 500; font-size: 1.11em; padding: 9px 13px; border-radius: 7px; transition: background .18s;}
        ...
        .table-area {width:100%; max-width:1100px; margin:36px auto 0 auto; background:#fff; border-radius:14px; box-shadow:0 2px 10px #20407605; padding:34px 36px 37px 36px;}
        .heading {font-size:1.25em; font-weight:700; margin-bottom:26px; color:#204076; text-align:center;}
        table {width:100%; border-collapse:collapse; margin-top:36px; font-size:1.09em;}
        th, td {padding:16px 11px; border-bottom:1px solid #e6ebee; text-align:center;}
        th {background:#eef4fa; font-weight:500; font-size:1em;}
        td {font-size:1em;}
        .form-card {background:#f7fafe; border-radius:13px; max-width:700px; margin:0 auto 34px auto; box-shadow:0 4px 25px #33406612; padding:30px 24px 18px 24px;}
        .form-row {display:flex; flex-wrap:wrap; gap:29px; margin-bottom:21px;}
        .form-row > div {flex:1 1 175px;}
        .finput {padding:11px 13px; font-size:1.08em; border-radius:7px; border:1px solid #d2d7e9; width:100%;}
        .send-btn {padding:12px 32px; background:#4066b3; color:#fff; font-size:1.07em; border:none; border-radius:8px; font-weight:700; margin-top:7px; cursor:pointer;}
        .send-btn:hover {background:#234488;}
        .editbtn {padding:8px 18px; background:#347edd; color:#fff; border:none; border-radius:8px; font-weight:600; margin-right:2px; cursor:pointer;}
        .editbtn:hover {background:#234488;}
        .result-alert {color:#094; text-align:center; margin-bottom:16px;}
        .label {font-weight:500; color:#234488; margin-bottom:4px; display:block;}
        .cancelbtn {padding:11px 28px; background:#bbb; color:#fff; border:none; border-radius:7px; font-weight:600; margin-left:17px; cursor:pointer;}
        .cancelbtn:hover {background:#888;}
        footer {background: #22283d; color: #f1f4fa; text-align: center; padding: 24px 0 18px 0; font-size:1.07em; margin-top: auto; font-weight:600;}
...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a href="resources_organizer_dashboard.php" class="active">RESOURCES</a>
    </div>
    ...
    <form method="post" autocomplete="off">
        ...
        <div class="form-row">
            ...
            <div>
                ...
                <input class="finput" name="quantity" type="number" min="1" required value="<?= $editRow['quantity'] ?>">
            </div>
            <div>
        ...
        <button name="saveResource" class="send-btn">Update</button>
        <a href="resources_organizer_dashboard.php" class="cancelbtn">Cancel</a>
    </form>
    </div>
    <?php endif; ?>
    <table>
