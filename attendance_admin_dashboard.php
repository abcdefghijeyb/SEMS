...
$attendance_stmt = $pdo->prepare("
    SELECT
    a.attendance_id,  -- <-- use this, not a.attendanceid
    u.name AS student,
...
<head>
    ...
    <style>
        ...
        @media print {
            .navbar, .menu, .print-btn, footer, .user-dropdown {display:none !important;}
            .table-area {box-shadow:none;padding:0;}
            body {background:#fff;}
        }
...
<body>
    <div class="navbar">
        ...
        <div class="menu">
            ...
            <a href="attendance_admin_dashboard.php" class="active">ATTENDANCE</a>
    ...
    <div class="table-area">
        ...
        <button class="print-btn" onclick="window.print()">PRINT ATTENDEES</button>
        <table>
            <thead>
                <tr>
                    <th>STUDENT</th>
