...
<head>
    ...
    <style>
        ...
        th {
            background:#eef4fa; font-weight:500;
        }
        td {
            font-size:1em;
        }
...
<body>
    <div class="navbar">
        ...
        <div class="menu">
            <a href="events_organizer_dashboard.php" class="active">EVENTS</a>
        ...
        <div class="user-dropdown">
            <div class="user-name"><?= htmlspecialchars($user_name ?? 'Organizer') ?></div>
