...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updateProfile'])) {
    ...
    // If password error, stay on form & show error—else continue update
    if(!$pass_error && empty($_POST['new_password'])) {
        ...
        header("Location: profile_admin_dashboard.php");
        exit();
    }
}
?>
...
<head>
    ...
    <style>
        ...
        .profile-card {
            background:#fff; 
            border-radius:18px;
             box-shadow:0 8px 40px #1820522a; 
        ...
        .profile-img{
            ...
            object-fit:cover;
            border-radius:50%;
            box-shadow:0 4px 24px #4066b350;
        ...
        .profile-img-box input[type=file]{
            margin-top:9px;
        }
...
<div class="navbar">
    ...
    <div class="user-dropdown">
        ...
        <div class="dropdown-content-user">
            <a href="profile_admin_dashboard.php" class="active">My Profile</a>
...
<div class="profile-area">
    <div class="profile-card">
        ...
        <form method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <a href="profile_admin_dashboard.php" class="cancel-btn">Cancel</a>
        </form>
        <?php endif; ?>
    </div>
</div>
