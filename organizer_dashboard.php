...
<head>
    <meta charset="UTF-8">
    <title>Organizer Dashboard | School Event Management System</title>
...
<body>
    ...
    <div class="main-content">
        <div class="welcome-area">
            ...
            <p>
                Efficiently manage events, attendance, notifications, and resources with your organizer privileges!
            </p>
        </div>
        <div class="img-area">
            <img src="https://img.icons8.com/ios/100/4071f4/organization.png" alt="Organizer Dashboard" />
        </div>
    </div>
    <footer>
